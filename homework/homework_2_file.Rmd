...
report <- read_csv(here::here("Data", 
                   "Report_Card_Assessment_Data_2018-19_School_Year_20231022.csv"),
                              na= "NULL")

shape <- st_read(here::here("Data",                         
                            "Washington_Counties_with_Natural_Shoreline___washsh_area",                           "Washington_Counties_with_Natural_Shoreline___washsh_area.shp"))
```
